                ...
                <div class="nav-links" id="navLinks">
                    ...
                    <ul>
                        ...
                        <?php
                            ...
                            <li >
                            <div class="dropdown">
                                <a class="dropbtn" href="novaobavestenja.php" style="color: rgb(247, 150, 29); text-shadow: 2px 1px 3px rgb(1,1,1);">ADMIN OPCIJE <i class="fa fa-caret-down"></i></a>
                                <div class="dropdown-content">
                                  <a  href="novaobavestenja.php">Nova obaveštenja</a>
                                  <a  href="korisnici.php">Upravljanje korisnicima</a>
                                  <a  href="novadokumenta.php" style="color: rgb(247, 150, 29); text-shadow: 2px 1px 3px rgb(1,1,1);">Nova dokumenta </a>
                                </div>
                            </div> 
                        </li>
                            ';
...
<!---------------------NOVA DOKUMENTA-------------------------------------------->
<?php
include "novadokumentadodaj.php";
?>
     <section class="qu">
        <ul class="breadcrumb">
            <li><a href="index.php">POČETNA</a></li>
            <li><a href="novadokumenta.php"> </a>ADMIN OPCIJE</li>
            <li>NOVA DOKUMENTA</li>
          </ul>
        </section>
        <section class="new-qu">
            <h2 class="h2so">NOVA DOKUMENTA </h2>
            <h4 style="color: rgb(247, 150, 29); font-style: italic; text-align: center;"><?php if(!empty($problem)) echo $problem;?></h4>
            <form action="" method="POST" enctype="multipart/form-data">
                <table class="table3">
                        <tr>
                            <td> <h1> Dodaj novi dokument </h1> </td>
                        </tr>
                        <tr>
                    ...
                    <tr>
                        <td>
                            <td colspan="2"><input type="submit" name="novidokument" value="Dodaj" class='red-btn'>
