...
<!---------------------NASTAVNI MATERIJAL---------------------------------------------->
     ...
     <section class="qu">
        ...
        <section class="notice">
           ...
           <ol>
               <li class="">
               <a  href="smer.php?smer=kategorija-1"> EKONOMSKI TEHNIČAR</a>
               <a  href="smer.php?smer=kategorija-2"> TEHNIČAR DRUMSKOG SAOBRAĆAJA</a>
               <a  href="smer.php?smer=kategorija-3">MAŠINSKI TEHNIČAR ZA KOMPJUTERSKO KONSTRUISANJE</a>
               <a  href="smer.php?smer=kategorija-4">TEHNIČAR ZA KOMPJUTERSKO UPRAVLJANJE (CNC) MAŠINA</a>
               <a  href="smer.php?smer=kategorija-5">MAŠINSKI TEHNIČAR MOTORNIH VOZILA</a>
               <a  href="smer.php?smer=kategorija-6"> AUTOMEHANIČAR</a>
               <a  href="smer.php?smer=kategorija-7"> MODELAR ODEĆE</a>
               <a  href="smer.php?smer=kategorija-8"> MODNI KROJAČ</a>
               <a  href="smer.php?smer=kategorija-9"> ELEKTROMEHANIČAR ZA TERMIČKE I RASHLADNE UREĐAJE</a>
               <a  href="smer.php?smer=kategorija-10"> ELEKTROINSTALATER</a>
            </li>
           </ol>
