                    ...
                    <ul>
                        ...
                        <li >
                            <div class="dropdown">
                                ...
                                <div class="dropdown-content">
                                  <a  href="sekcije.php" style="color: rgb(247, 150, 29); text-shadow: 2px 1px 3px rgb(1,1,1);">Sekcije</a>
...
<!---------------------SEKCIJE-------------------------------------------->
    ...
    <section class="new-qu">
        <h2 class="h2so">SEKCIJE </h2>
        <p class="psr"> Slobodne aktivnosti su skup za koje se pojedinac može slobodno opredeliti. Osnovne funkcije aktivnosti u slobodnom vremenu su : odmor razonoda i razvoj licnosti. Pored toga ove tri funkcije predstavljaju i tri područja programiranja slobodnih aktivnosti u školi, a u okviru rada različitih sekcija. </p>
        <p class="psr">Sekcije će raditi tokom cele godine, a sadržaji i rezultati njihovog rada javno se prezentuju kroz određene prigodbe i programe: takmičenja, izložbe, kulturne manifestacije, praznike, svečanosti i dr. Uspešan rad sekcija omogućava tešnju saradnju sa društvenom sredinom i afirmiše školu u opštini i široj sredini.</p>
        <table class="new-table" style="margin: 10px auto; padding: 10px;">
            <tr>
                <th> Sekcija </th>
                <th> Rukovodioci </th>
            </tr>
            <tr>
                <td><p> Recitatorska sekcija</p></td>
                <td> <p> Azemina Hadžić</p></td>
            </tr>
            <tr>
                <td class="even"> <p> Dramska sekcija </p></td>
                <td class="even"><p>Edita Pepić </p></td>
            </tr>
            <tr>
                <td><p> Literarna sekcija </p></td>
                <td><p> Emina Muratović </p></td>
            </tr>
            <tr>
                <td class="even"><p>Sekcija za računarstvo i informatiku </p></td>
                <td class="even"><p> Damir Hadžić </p></td>
            </tr>
            <tr>
                <td><p> Sekcija za košarku </p></td>
                <td><p> Imer Ademović </p></td>
            </tr>
            <tr>
                <td class="even"><p> Sekcija za odbojku </p></td>
                <td class="even"><p> Remzo Metović </p></td>
            </tr>
            <tr>
                <td><p> Sekcija za gimnastiku </p></td>
                <td><p> Amil Bronja </p></td>
            </tr>
            <tr>
                <td class="even"><p> Sekcija za rukomet </p></td>
                <td class="even"><p> Admira Koničanin</p></td>
            </tr>
            <tr>
                <td><p> Sekcija za fudbal </p></td>
                <td><p> Imer Ademović, </p> </br> <p> Remzo Metović </p> </td>
            </tr>
            <tr>
                <td class="even"><p> Ekološka sekcija </p></td>
                <td class="even"><p> Harun Eminović </p></td>
            </tr>
            <tr>
                <td><p> Mladi geografi </p></td>
                <td><p> Lejla Gegić </p></td>
            </tr>
            <tr>
                <td class="even"><p> Sekcija fizičara </p></td>
                <td class="even"><p> Magbula Džemić </p></td>
            </tr>
            <tr>
                <td><p> Sekcija za matematiku </p></td>
                <td><p> Sabina Dazdarević </p></td>
            </tr>
            <tr>
                <td class="even"><p> Likovna sekcija</p></td>
                <td class="even"><p> Dušan Popović</p></td>
            </tr>
        </table>
        <p class="psr">Planovi sekcija biće posebno doneti od strane rukovodioca sekcija i pređstavlja sastavni deo godišneg Programa rada. Uputstvo za rad sekcija dato je u “Službenom glasniku - Prosvetni glasnik RS”broj 3/91.</p>
    </section>
