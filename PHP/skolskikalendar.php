                        ...
                        <li>
                            <div class="dropdown">
                                ...
                                <div class="dropdown-content">
                                  ...
                                  <a  href="skolskikalendar.php" style="color: rgb(247, 150, 29); text-shadow: 2px 1px 3px rgb(1,1,1);"> Školski kalendar </a>
                                </div>
                              </div> 
                            </li>
                        <li>
...
<!---------------------SKOLSKI KALENDAR--------------------------------------------->
     ...
     <section class="qu">
        <ul class="breadcrumb">
            ...
            <li>ŠKOLSKI KALENDAR</li>
          </ul>
        </section>
        <section class="new-qu">
            <h2 class="h2so"> ŠKOLSKI KALENDAR </h2>
            <img src="images/kalendar.PNG" style=" height: auto; margin: 50px auto; display: block;
            margin-left: auto;
            margin-right: auto;
            width: 50%; ">
