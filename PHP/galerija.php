                        ...
                        <li >
                            <div class="dropdown">
                                ...
                                <div class="dropdown-content">
                                  ...
                                  <a href="galerija.php" style="color: rgb(247, 150, 29); text-shadow: 2px 1px 3px rgb(1,1,1);">Galerija </a>
...
<!---------------------GALERIJA-------------------------------------------->
	...
	<div class="top">
    	...
    	<ul>
        <li><a href="#img_0"><img src="images/sl.jpg"></a>
        <li><a href="#img_1"><img src="images/slika1.jpg"></a></li>
        <li><a href="#img_2"><img src="images/slika2.jpg"></a></li>
        <li><a href="#img_3"><img src="images/slika3.jfif"></a></li>
        <li><a href="#img_4"><img src="images/slika4.jpg"></a></li>
        <li><a href="#img_5"><img src="images/slika6.jfif"></a></li>
        <li><a href="#img_6"><img src="images/slika5.jfif"></a></li>
        <li><a href="#img_7"><img src="images/slika7.jfif"></a></li>
        <li><a href="#img_8"><img src="images/slika8.jfif"></a></li>
        <li><a href="#img_9"><img src="images/slika17.jfif"></a></li>
        <li><a href="#img_10"><img src="images/slika10.jfif"></a></li>
        <li><a href="#img_11"><img src="images/slika18.jpg"></a></li>
        <li><a href="#img_12"><img src="images/slika11.jfif"></a></li>
        <li><a href="#img_13"><img src="images/slika12.jfif"></a></li>
        <li><a href="#img_14"><img src="images/slika13.jpg"></a></li>
        <li><a href="#img_15"><img src="images/slika14.jfif"></a></li>
      
            
        </ul>
        <a href="#_0" class="lightbox trans" id="img_0"><img src="images/sl.jpg"></a>
        <a href="#_1" class="lightbox trans" id="img_1"><img src="images/slika1.jpg"></a>
        <a href="#_2" class="lightbox trans" id="img_2"><img src="images/slika2.jpg"></a>
        <a href="#_3" class="lightbox trans" id="img_3"><img src="images/slika3.jfif"></a>
        <a href="#_4" class="lightbox trans" id="img_4"><img src="images/slika4.jpg"></a>
        <a href="#_5" class="lightbox trans" id="img_5"><img src="images/slika6.jfif"></a>
        <a href="#_6" class="lightbox trans" id="img_6"><img src="images/slika5.jfif"></a>
        <a href="#_7" class="lightbox trans" id="img_7"><img src="images/slika7.jfif"></a>
        <a href="#_8" class="lightbox trans" id="img_8"><img src="images/slika8.jfif"></a> 
        <a href="#_9" class="lightbox trans" id="img_9"><img src="images/slika17.jfif"></a>
        <a href="#_10" class="lightbox trans" id="img_10"><img src="images/slika10.jfif"></a>
        <a href="#_11" class="lightbox trans" id="img_11"><img src="images/slika18.jpg"></a>
        <a href="#_12" class="lightbox trans" id="img_12"><img src="images/slika11.jfif"></a> 
        <a href="#_13" class="lightbox trans" id="img_13"><img src="images/slika12.jfif"></a>
        <a href="#_14" class="lightbox trans" id="img_14"><img src="images/slika13.jpg"></a>
        <a href="#_15" class="lightbox trans" id="img_15"><img src="images/slika14.jfif"></a>
