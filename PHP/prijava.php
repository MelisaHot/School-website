                ...
                <div class="nav-links" id="navLinks">
                    ...
                    <ul>
                        ...
                        <?php
                            ...
                            echo "   
                            <li ><a href='odjava.php'style='color: rgb(247, 150, 29); text-shadow: 2px 1px 3px rgb(1,1,1);'>ODJAVI SE</a></li>
                                ";
                            }else{
                            echo "   
                                    <li ><a href=' prijava.php' style='color: rgb(247, 150, 29); text-shadow: 2px 1px 3px rgb(1,1,1);'>PRIJAVI SE</a></li>
                                ";
                            } 
                        ?>
        ...
        <section class="new-qu">
            ...
            <?php 
				...
				if(isset($_SESSION['user'])){
					...
					echo "
                        <h1 style=' color:rgb(250, 157, 44); font-style: italic; font-size:20px; padding-top:20px; text-align:center;'>DOBRODOŠLI: {$_SESSION['user']}</h1> 
          
					";
					
				} else
				{ echo '
                    <h2 class="h2so">PRIJAVI SE </h2>
            <form action="login.php" method="POST">
                <table class="table3">
                    ...
                    <tr>
                        <td>
                            <td colspan="2"><input type="submit" name="prijava" value="Prijavi se" class="red-btn">
