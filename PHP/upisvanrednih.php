                        ...
                        <li>
                            <div class="dropdown">
                                ...
                                <div class="dropdown-content">
                                  ...
                                  <a  href="upisvanrednih.php" style="color: rgb(247, 150, 29); text-shadow: 2px 1px 3px rgb(1,1,1);">Upis vanrednih učenika</a>
...
<!---------------------UPIS VANREDNIH KANDIDATA------------------------------------------->

    <section class="qu">
        <ul class="breadcrumb">
            <li><a href="index.php">POČETNA</a></li>
            <li><a href="vanrednikandidati.php">VANREDNI KANDIDATI</a></li>
            <li>UPIS VANREDNIH UČENIKA</li>
        </ul>
    </section>
    <section class="new-qu">
        <h2 class="h2so"> UPIS VANREDNIH UČENIKA </h2>
        <p class="pso"> Za upis vanrednih učenika potrebna dokumenta su: </p>
        <ul class="ulsr" >
            <li>
                Svedočanstva o završenoj prethodnoj kvalifikaciji 
            </li>
            <li>
                Diploma o završenoj kvalifikaciji
            </li>
            <li>
                Izvod iz matične knjige rođenih 
            </li>
        </ul>
        <p class="pso"> *Ukoliko je došlo ili dođe u toku školovanja do promene prezimena usled sklapanja braka potrebno je dostaviti izvod venčanih. </p>
