            ...
            <nav >
                ...
                <div class="nav-links" id="navLinks">
                    ...
                    <ul>
                        ...
                        <li >
                            <div class="dropdown">
                                <a class="dropbtn" href="dokumenti.php" style="color: rgb(247, 150, 29); text-shadow: 2px 1px 3px rgb(1,1,1);">DOKUMENTI <i class="fa fa-caret-down"></i></a>
                                <div class="dropdown-content">
                                  <a href="dokumenti.php" style="color: rgb(247, 150, 29); text-shadow: 2px 1px 3px rgb(1,1,1);">Dokumenti škole</a>                              
                                </div>
                              </div> 
                        </li>
...
<!--------------------DOKUMENTI---------------------------------------------->
    ...
    <section class="qu">
      <ul class="breadcrumb">
          ...
          <li>DOKUMENTI ŠKOLE</li>
      </ul>
    </section>
    <section class="notice">
      <h2 class="h2so">DOKUMENTI ŠKOLE</h2>
      <ol>
      <?php
      require 'Connection.php';
        $query = "SELECT * FROM dokumenta ORDER BY id DESC";  
        $result = mysqli_query($conn, $query);  
        while($row = mysqli_fetch_array($result))  
        {   
            echo "  
            <li class=''>
            <a target='_blank' href='viewDoc.php?id=".$row['id']."'>".$row['ime']. "</a>
            </li>"; 
        }   
      ?>
      </ol>
